...
Added
~~~~~
* Initial support for sending monitoring data to OpenTelemetry collector, configured by new Django setting ``OPENEDX_TELEMETRY``. See monitoring README for details.
